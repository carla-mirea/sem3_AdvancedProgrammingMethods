...
public class ProgramRunController implements Initializable {
    ...
    private void loadData(){
        ...
        if(selectedProgram!=null){
            ...
            MyILockTable lockTable = Objects.requireNonNull(selectedProgram).getLockTable();
            ...
            locationColumn.setCellValueFactory(p -> new SimpleStringProperty(p.getValue().getKey().toString()));
