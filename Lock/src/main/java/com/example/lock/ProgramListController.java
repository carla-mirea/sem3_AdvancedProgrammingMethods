    ...
    public void setListView() throws MyException, IOException {
        ...
        try {
            ...
            PrgState prg1 = new PrgState(stack1, new MyDictionary<String, Value>(),
                    new MyList<Value>(), new MyDictionary<StringValue, BufferedReader>(), new MyHeap<>(), new MyLockTable(), ex1);
        ...
        try {
            ...
            PrgState prg2 = new PrgState(stack2, new MyDictionary<String, Value>(), new MyList<Value>(),
                    new MyDictionary<StringValue, BufferedReader>(), new MyHeap<>(), new MyLockTable(), ex2);
        ...
        try {
            ...
            PrgState prg3 = new PrgState(stack3, new MyDictionary<String, Value>(), new MyList<Value>(),
                    new MyDictionary<StringValue, BufferedReader>(), new MyHeap<>(), new MyLockTable(), ex3);
        ...
        try {
            ...
            PrgState prg4 = new PrgState(stack4, new MyDictionary<String, Value>(), new MyList<Value>(),
                    new MyDictionary<StringValue, BufferedReader>(), new MyHeap<>(), new MyLockTable(), ex4);
        ...
        try {
            ...
            PrgState prg5 = new PrgState(stack5, new MyDictionary<>(), new MyList<>(),
                    new MyDictionary<>(), new MyHeap<>(), new MyLockTable(), ex5);
        ...
        try {
            ...
            PrgState prg6 = new PrgState(stack6, new MyDictionary<>(), new MyList<Value>(), new MyDictionary<>(), new MyHeap<>(), new MyLockTable(), ex6);
        ...
        try {
            ...
            PrgState prg7 = new PrgState(stack7, new MyDictionary<>(), new MyList<>(), new MyDictionary<>(), new MyHeap<>(), new MyLockTable(), ex7);
        ...
        try {
            ...
            PrgState prg8 = new PrgState(stack8, new MyDictionary<>(), new MyList<>(), new MyDictionary<>(), new MyHeap<>(), new MyLockTable(), ex8);
        ...
        try {
            ...
            PrgState prg9 = new PrgState(stack9, new MyDictionary<>(), new MyList<>(), new MyDictionary<>(), new MyHeap<>(), new MyLockTable(), ex9);
