...
public class ProgramRunController implements Initializable {
    ...
    private void loadData(){
        ...
        if(selectedProgram!=null){
            ...
            MyILatchTable latchTable = this.selectedProgram.getLatchTable();
            ...
            latchTableView.setItems(FXCollections.observableList(latchTableEntries));

            latchLocationColumn.setCellValueFactory(p -> new SimpleIntegerProperty(p.getValue().getValue()).asObject());
            latchValueColumn.setCellValueFactory(p -> new SimpleIntegerProperty(p.getValue().getKey()).asObject());
