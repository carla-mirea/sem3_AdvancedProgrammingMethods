    ...
    public void setListView() throws MyException, IOException {
        ...
        try {
            ...
            PrgState prg1 = new PrgState(stack1, new MyDictionary<String, Value>(),
                    new MyList<Value>(), new MyDictionary<StringValue, BufferedReader>(), new MyHeap<>(), new MyBarrierTable(), ex1);
        ...
        try {
            ...
            PrgState prg2 = new PrgState(stack2, new MyDictionary<String, Value>(), new MyList<Value>(),
                    new MyDictionary<StringValue, BufferedReader>(), new MyHeap<>(), new MyBarrierTable(), ex2);
        ...
        try {
            ...
            PrgState prg3 = new PrgState(stack3, new MyDictionary<String, Value>(), new MyList<Value>(),
                    new MyDictionary<StringValue, BufferedReader>(), new MyHeap<>(), new MyBarrierTable(), ex3);
        ...
        try {
            ...
            PrgState prg4 = new PrgState(stack4, new MyDictionary<String, Value>(), new MyList<Value>(),
                    new MyDictionary<StringValue, BufferedReader>(), new MyHeap<>(), new MyBarrierTable(), ex4);
        ...
        try {
            ...
            PrgState prg5 = new PrgState(stack5, new MyDictionary<>(), new MyList<>(),
                    new MyDictionary<>(), new MyHeap<>(), new MyBarrierTable(), ex5);
        ...
        try {
            ...
            PrgState prg6 = new PrgState(stack6, new MyDictionary<>(), new MyList<Value>(), new MyDictionary<>(), new MyHeap<>(), new MyBarrierTable(), ex6);
        ...
        try {
            ...
            PrgState prg7 = new PrgState(stack7, new MyDictionary<>(), new MyList<>(), new MyDictionary<>(), new MyHeap<>(), new MyBarrierTable(), ex7);
        ...
        try {
            ...
            PrgState prg8 = new PrgState(stack8, new MyDictionary<>(), new MyList<>(), new MyDictionary<>(), new MyHeap<>(), new MyBarrierTable(), ex8);
        ...
        try {
                                            ...
                                            new CompStmt(
                                                    ...
                                                    new CompStmt(
                                                            ...
                                                            new CompStmt(
                                                                    ...
                                                                    new CompStmt(
                                                                            new NewBarrierStatement("cnt", new ReadHeapExp(new VarExp("v2"))),
                                                                            new CompStmt(
                                                                                    new ForkStmt(
                                                                                            new CompStmt(
            ...
            PrgState prg9 = new PrgState(stack9, new MyDictionary<>(), new MyList<>(), new MyDictionary<>(), new MyHeap<>(), new MyBarrierTable(), ex9);
