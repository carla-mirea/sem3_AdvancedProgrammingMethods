...
public class PrgState {
    ...
    public PrgState(IStack<IStmt> stk, IDictionary<String, Value> symtbl, IList<Value> ot, IDictionary<StringValue, BufferedReader> table, IHeap<Value> givenHeap, MyIToySemaphoreTable toySemTable, IStmt prg) {
        exeStack = stk;
        symTable = symtbl;
        out = ot;
        fileTable = table;
        ...
        stk.push(prg);
        currentId = incId();
        toySemaphoreTable = toySemTable;
    }

    public PrgState(IStack<IStmt> stk, IDictionary<String, Value> symtbl, IList<Value> ot, IDictionary<StringValue, BufferedReader> table, IHeap<Value> givenHeap, MyIToySemaphoreTable toySemTable) {
        exeStack = stk;
        symTable = symtbl;
        out = ot;
        fileTable = table;
