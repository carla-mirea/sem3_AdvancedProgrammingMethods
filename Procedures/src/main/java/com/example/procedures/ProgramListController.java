...
public class ProgramListController {
    ...
    private MyIProcTable procTable = new MyProcTable();
    ...
    public void setListView() throws MyException, IOException {
        ...
        try {
            ...
            IStack<IDictionary<String, Value>> symTableStack1 = new MyStack<>();
            symTableStack1.push(new MyDictionary<>());
            PrgState prg1 = new PrgState(stack1, symTableStack1,
                    new MyList<Value>(), new MyDictionary<StringValue, BufferedReader>(), new MyHeap<>(), procTable, ex1);
        ...
        try {
            ...
            IStack<IDictionary<String, Value>> symTableStack2 = new MyStack<>();
            symTableStack2.push(new MyDictionary<>());
            PrgState prg2 = new PrgState(stack2, symTableStack2, new MyList<Value>(),
                    new MyDictionary<StringValue, BufferedReader>(), new MyHeap<>(), procTable, ex2);
        ...
        try {
            ...
            IStack<IDictionary<String, Value>> symTableStack3 = new MyStack<>();
            symTableStack3.push(new MyDictionary<>());
            PrgState prg3 = new PrgState(stack3, symTableStack3, new MyList<Value>(),
                    new MyDictionary<StringValue, BufferedReader>(), new MyHeap<>(), procTable, ex3);
        ...
        try {
            ...
            IStack<IDictionary<String, Value>> symTableStack4 = new MyStack<>();
            symTableStack4.push(new MyDictionary<>());
            PrgState prg4 = new PrgState(stack4, symTableStack4, new MyList<Value>(),
                    new MyDictionary<StringValue, BufferedReader>(), new MyHeap<>(), procTable, ex4);
        ...
        try {
            ...
            IStack<IDictionary<String, Value>> symTableStack5 = new MyStack<>();
            symTableStack5.push(new MyDictionary<>());
            PrgState prg5 = new PrgState(stack5, symTableStack5, new MyList<>(),
                    new MyDictionary<>(), new MyHeap<>(), procTable, ex5);
        ...
        try {
            ...
            IStack<IDictionary<String, Value>> symTableStack6 = new MyStack<>();
            symTableStack6.push(new MyDictionary<>());
            PrgState prg6 = new PrgState(stack6, symTableStack6, new MyList<Value>(), new MyDictionary<>(), new MyHeap<>(), procTable, ex6);
        ...
        try {
            ...
            IStack<IDictionary<String, Value>> symTableStack7 = new MyStack<>();
            symTableStack7.push(new MyDictionary<>());
            PrgState prg7 = new PrgState(stack7, symTableStack7, new MyList<>(), new MyDictionary<>(), new MyHeap<>(), procTable, ex7);
        ...
        try {
            ...
            IStack<IDictionary<String, Value>> symTableStack8 = new MyStack<>();
            symTableStack8.push(new MyDictionary<>());
            PrgState prg8 = new PrgState(stack8, symTableStack8, new MyList<>(), new MyDictionary<>(), new MyHeap<>(), procTable, ex8);
                ...
                new CompStmt(
                        ...
                        new CompStmt(
                                ...
                                new CompStmt(
                                        ...
                                        new CompStmt(
                                                new CallProcStatement("sum", new ArrayList<>(Arrays.asList(new ArithExp('*', new VarExp("v"), new ValueExp(new IntValue(10))), new VarExp("w")))),
                                                new CompStmt(
                                                        new PrintStmt(new VarExp("v")),
                                                        new ForkStmt(
                                                                new CompStmt(
                                                                        new CallProcStatement("product", new ArrayList<>(Arrays.asList(new VarExp("v"), new VarExp("w")))),
                                                                        new ForkStmt(
                                                                                new CallProcStatement("sum", new ArrayList<>(Arrays.asList(new VarExp("v"), new VarExp("w"))))
                                                                        )
                                                                )
                                                        )
                                                )
        ...
        try {
            ...
            IStack<IDictionary<String, Value>> symTableStack9 = new MyStack<>();
            symTableStack9.push(new MyDictionary<>());
            PrgState prg9 = new PrgState(stack9, symTableStack9, new MyList<>(), new MyDictionary<>(), new MyHeap<>(), procTable, ex9);
